...
mod vlc {
    ...
    mod tests {
        ...
        type Event = <VLC as ::ink_lang::BaseEvent>::Type;
        ...
        fn transfer_works() {
            ...
            assert_eq!(vlc.transfer(accounts.bob, 10), Ok(()));
            // Bob owns 10 tokens.
            assert_eq!(vlc.balance_of(accounts.bob), 10);
        ...
        fn invalid_transfer_should_fail() {
            ...
            assert_eq!(
                vlc.transfer(accounts.eve, 10),
                Err(Error::InsufficientBalance)
            );
            // Alice owns all the tokens.
            assert_eq!(vlc.balance_of(accounts.alice), 100);
            assert_eq!(vlc.balance_of(accounts.bob), 0);
            assert_eq!(vlc.balance_of(accounts.eve), 0);
        ...
        fn transfer_from_works() {
            ...
            assert_eq!(
                vlc.transfer_from(accounts.alice, accounts.eve, 10),
                Err(Error::InsufficientAllowance)
            );
            // Alice approves Bob for token transfers on her behalf.
            assert_eq!(vlc.approve(accounts.bob, 10), Ok(()));
            ...
            assert_eq!(vlc.transfer_from(accounts.alice, accounts.eve, 10), Ok(()));
            // Eve owns tokens.
            assert_eq!(vlc.balance_of(accounts.eve), 10);
        ...
        fn allowance_must_not_change_on_failed_transfer() {
            ...
            assert_eq!(
                vlc.allowance(accounts.alice, accounts.bob),
                initial_allowance
            );
